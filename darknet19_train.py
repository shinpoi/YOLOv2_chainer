...
from lib.image_generator_2 import *
...
generator = ImageGenerator(BKroot, ITEMroot)
generator.init_all()
# generator.save_imgspool_backup()
...
for batch in range(max_batches):
    # generate sample
    x, t = generator.create_batch(batch_size=batch_size, img_size=input_height)
    x = Variable(x)
    one_hot_t = []
